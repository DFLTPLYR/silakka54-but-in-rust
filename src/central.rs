...
async fn main(_spawner: Spawner) {
    ...
    // Pin config
    let (row_pins, col_pins) = config_matrix_pins_rp!(peripherals: p, input: [PIN_2, PIN_3, PIN_4, PIN_5, PIN_6], output: [PIN_7, PIN_8, PIN_9, PIN_10, PIN_11, PIN_12]);
